# PowerShell Masterclass — LP03 (Deploy and manage Azure compute resources)

## Purpose
Run LP03 governance operations with PowerShell-first workflows that are scriptable, auditable, and easy to automate.
