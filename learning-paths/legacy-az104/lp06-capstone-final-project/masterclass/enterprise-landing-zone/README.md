...
|---|---|---|---|
| Global variables and naming | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/variables.env` | Azure CLI account and context | [Azure CLI account](https://learn.microsoft.com/en-us/cli/azure/account) |
| Resource groups | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/00-rg.bicep` | `az group` | [Azure CLI group](https://learn.microsoft.com/en-us/cli/azure/group) |
| Hub VNet and subnets | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/01-hub-network.bicep` | `az network vnet` | [Azure CLI network vnet](https://learn.microsoft.com/en-us/cli/azure/network/vnet) |
| Spoke VNets and subnets | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/02-spoke-network.bicep` | `az network vnet` | [Azure CLI network vnet](https://learn.microsoft.com/en-us/cli/azure/network/vnet) |
| VNet peerings | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/03-peering.bicep` | `az network vnet peering` | [Azure CLI vnet peering](https://learn.microsoft.com/en-us/cli/azure/network/vnet/peering) |
| Route tables and spoke forced tunnel | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/04-routing.bicep` | `az network route-table` and `az network nic show-effective-route-table` | [Azure CLI route-table](https://learn.microsoft.com/en-us/cli/azure/network/route-table) |
| NSGs and baseline network controls | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/05-nsg.bicep` | `az network nsg` | [Azure CLI nsg](https://learn.microsoft.com/en-us/cli/azure/network/nsg) |
| VPN gateway | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/06-vpn-gateway.bicep` | `az network vnet-gateway` | [Azure CLI vnet-gateway](https://learn.microsoft.com/en-us/cli/azure/network/vnet-gateway) |
| Local network gateway and S2S connection | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/07-vpn-connection.bicep` | `az network local-gateway` and `az network vpn-connection` | [Azure CLI local-gateway](https://learn.microsoft.com/en-us/cli/azure/network/local-gateway) |
| OPNsense marketplace deployment notes (portal step) | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/08-opnsense-marketplace.md` | Portal deployment and post-check via `az vm`/`az network nic` | [Azure CLI vm](https://learn.microsoft.com/en-us/cli/azure/vm) |
| OPNsense hardening checklist | `learning-paths/az204-lp05-connect-consume-azure-services/evidence/opnsense-hardening-checklist.md` | OPNsense web console procedure | [OPNsense hardening](https://docs.opnsense.org/manual/hardening.html) |
| OPNsense firewall policy export | `learning-paths/az204-lp05-connect-consume-azure-services/evidence/opnsense-firewall-rules.csv` | OPNsense firewall and NAT policy operations | [OPNsense firewall](https://docs.opnsense.org/manual/firewall.html) |
| Spoke validation VM | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/09-spoke-vm.bicep` | `az vm` | [Azure CLI vm](https://learn.microsoft.com/en-us/cli/azure/vm) |
| Hub validation endpoint VM | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/10-hub-validation-vm.bicep` | `az vm` | [Azure CLI vm](https://learn.microsoft.com/en-us/cli/azure/vm) |
| Managed identity and RBAC | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/11-identity-rbac.bicep` | `az identity` and `az role assignment` | [Azure CLI identity](https://learn.microsoft.com/en-us/cli/azure/identity) |
| Policy assignments and exemptions | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/12-policy.bicep` | `az policy assignment` and `az policy exemption` | [Azure CLI policy assignment](https://learn.microsoft.com/en-us/cli/azure/policy/assignment) |
| Locks | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/13-locks.bicep` | `az lock` | [Azure CLI lock](https://learn.microsoft.com/en-us/cli/azure/lock) |
| Storage account and protection controls | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/14-storage.bicep` | `az storage account` | [Azure CLI storage account](https://learn.microsoft.com/en-us/cli/azure/storage/account) |
| Private endpoints and private DNS | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/15-private-endpoints.bicep` | `az network private-endpoint` and `az network private-dns` | [Azure CLI private-endpoint](https://learn.microsoft.com/en-us/cli/azure/network/private-endpoint) |
| Log Analytics workspace | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/16-log-analytics.bicep` | `az monitor log-analytics workspace` | [Azure CLI log-analytics workspace](https://learn.microsoft.com/en-us/cli/azure/monitor/log-analytics/workspace) |
| Diagnostic settings | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/17-diagnostic-settings.sh` | `az monitor diagnostic-settings` | [Azure CLI diagnostic-settings](https://learn.microsoft.com/en-us/cli/azure/monitor/diagnostic-settings) |
| Alerts and action groups | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/18-alerts.bicep` | `az monitor metrics alert` and `az monitor action-group` | [Azure CLI metrics alert](https://learn.microsoft.com/en-us/cli/azure/monitor/metrics/alert) |
| Recovery Services vault and backup policy | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/19-backup.bicep` | `az backup` | [Azure CLI backup](https://learn.microsoft.com/en-us/cli/azure/backup) |
| End-to-end validation script | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/validate-capstone.sh` | `az network`, `az vm run-command`, and route checks | [Azure CLI network nic](https://learn.microsoft.com/en-us/cli/azure/network/nic) |
| PowerShell orchestration equivalent | `learning-paths/az204-lp05-connect-consume-azure-services/artifacts/Deploy-Capstone.ps1` | `Az.Network`, `Az.Resources`, `Az.Monitor`, `Az.RecoveryServices` | [Azure PowerShell Az](https://learn.microsoft.com/en-us/powershell/azure/new-azureps-module-az) |
