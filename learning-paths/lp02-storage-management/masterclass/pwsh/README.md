# PowerShell Masterclass — LP02 (Implement and manage storage in Azure)

## Purpose
Run LP02 governance operations with PowerShell-first workflows that are scriptable, auditable, and easy to automate.
