# PowerShell Masterclass — LP04 (Configure and manage virtual networks for Azure administrators)

## Purpose
Run LP04 governance operations with PowerShell-first workflows that are scriptable, auditable, and easy to automate.
