# PowerShell Masterclass — LP05 (Monitor and back up Azure resources)

## Purpose
Run LP05 governance operations with PowerShell-first workflows that are scriptable, auditable, and easy to automate.
